...
const New = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    Phone: '',
    City: '',
    Role: 'Client', // Set a default value
    Password: '',
  });
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.Name || !formData.LastName || !formData.Email || !formData.Phone || !formData.City || !formData.Role || !formData.Password) {
      setFormValid(false);
      return;
    }
      ...
      <div className=' bg-gray-100 shadow-lg dark:bg-gray-900 max-w-3xl px-1 mx-auto lg:px-6'>
        <div style={formContainerStyle}>
          <form onSubmit={handleSubmit}>
            ...
            <input value={'Create Account'} className='flex items-center justify-center bg-stone-400 text-orange-900 font-semibold text-xl' type="submit" style={buttonStyle}/>
          </form>
        </div>
